...
Проект помощника одиночных проверок экономики отряда и прогрессии.
...
- **Party economy sheets** — запланированный модуль; реализации нет.
- **Skill progression scenarios** — запланированный модуль; реализации нет.
- **Campaign backup ledger** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Party economy sheets**.
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Mount & Blade II: Bannerlord, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Skill progression scenarios

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Mount & Blade II: Bannerlord, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Campaign backup ledger

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Mount & Blade II: Bannerlord, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Mount & Blade II: Bannerlord |
...
| Планируемый результат | Party economy sheets |
