...
<div align="center">
  <img src="./public/logo.svg" alt="BannerBudget — Mount &amp; Blade II: Bannerlord — Banners" width="64" height="64">
  <h1>BannerBudget — Mount &amp; Blade II: Bannerlord — Banners</h1>
</div>

An independent project specification for Mount & Blade II: Bannerlord, covering party economy sheets, skill progression scenarios, campaign backup ledger.
...
<img src="./public/screenshots/desktop-main.svg" alt="Mount &amp; Blade II: Bannerlord — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Mount &amp; Blade II: Bannerlord — compact concept, not a screenshot" width="250">
<br>
...
- **Party economy sheets** — planned module; not implemented.
- **Skill progression scenarios** — planned module; not implemented.
- **Campaign backup ledger** — planned module; not implemented.

The proposed workflow separates party economy sheets from skill progression scenarios, with campaign backup ledger retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Party economy sheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="BannerBudget — Mount &amp; Blade II: Bannerlord — Banners — specification review workflow">
<br>
...
### Party economy sheets

Define the input and expected outcome for module 1. Record the Mount & Blade II: Bannerlord version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Skill progression scenarios

Define the input and expected outcome for module 2. Record the Mount & Blade II: Bannerlord version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Campaign backup ledger

Define the input and expected outcome for module 3. Record the Mount & Blade II: Bannerlord version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Party economy sheets |
